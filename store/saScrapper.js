            ...
            try {
                ...
                for (const item of items) {
                    try {
                        ...
                        const lede = (p ===null)?null: await page.evaluate(p => p.innerHTML, p);
                        ...
                        const tag = (cat != null || undefined) ? await cat.$eval('a', a => a.innerText) : null;
                        const catLink = (cat != null || undefined) ? await cat.$eval('a', a => a.href) : null;
                        ...
                        let src_logo = "https://www.thesouthafrican.com/wp-content/uploads/2018/08/south_african_news_online.png";
                        let images = empty;
                        let isVid = empty;
                        let vidLen = empty;
